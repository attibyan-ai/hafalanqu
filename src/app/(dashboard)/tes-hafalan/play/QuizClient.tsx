  ...
  return (
    <div className="max-w-3xl mx-auto mt-6">
      ...
      >
        ...
        <div 
          className="font-amiri text-3xl md:text-4xl leading-[3] text-dark mb-8" 
          dir="rtl"
        >
        ...
        <AnimatePresence>
          {currentQ.options.map((opt, idx) => {
            ...
            return (
              ...
              >
                <div 
                  className={jenis !== "tebak-surah" ? "font-amiri text-3xl md:text-4xl leading-[3] py-1" : "font-semibold text-lg"} 
